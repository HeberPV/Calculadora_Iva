...
public class CalculadoraIvaConLista extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e){
		...
		if(caja1.getText().length()==0) {
			JOptionPane.showMessageDialog(this, "Ingrese un numero pues >:v", "NO SEA MECO", 1);
		}else {
			...
			if(selectIva=="16%"){
				...
				JOptionPane.showMessageDialog(this, "Seleecione una opcion de Iva", "NO SEA MECO", 1);
			}
			
			if(resultado!=0) {
			resultado=resultado+numero;
			JOptionPane.showMessageDialog(this, "El resultado es: "+resultado, "COMPILA Y SI HACE ALGO", 1);
			}
		}
	}
